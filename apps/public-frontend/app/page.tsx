...
const processSteps = [
  {
    image: SITE_IMAGES.customOrder,
    alt: "Эскизы, заметки и материалы для будущего ножа",
    title: "Выбираем задачу",
    text: "Фиксируем сценарий: кухня, поход, подарок, коллекция или похожая работа из галереи."
  },
  {
    image: SITE_IMAGES.processHandle,
    alt: "Заготовки дерева и материалы для рукояти ножа",
    title: "Подбираем материалы",
    text: "Согласуем сталь, рукоять, ножны, упаковку, гравировку и документы до начала работы."
  },
  {
    image: SITE_IMAGES.processForging,
    alt: "Ковка раскаленного клинка на наковальне",
    title: "Делаем клинок",
    text: "Форма, спуски и термообработка подбираются под назначение изделия, а не под шаблонную форму."
  },
  {
    image: SITE_IMAGES.processHandle,
    alt: "Ручная обработка деревянной рукояти ножа",
    title: "Собираем рукоять",
  ...
  },
  {
    ...
    title: "Точим, проверяем и упаковываем",
...
const featureCards = [
  ...
  },
  {
    ...
    text: "Готовые изделия можно оплатить через корзину, а доставку и передачу мастер согласует отдельно."
  }
];
        ...
        <div className="container hero-layout">
          <div className="hero-copy">
            ...
            <p className="hero-lead">
              {site.heroSubtitle ??
                "Готовые работы, галерея выполненных изделий и индивидуальные заказы напрямую у мастера."}
            </p>
      ...
      <section className="section">
        <div className="container">
          <div className="section-head">
            ...
            <h2 className="section-title">Как заказ проходит через мастерскую</h2>
            <p className="section-copy">
              Это не просто фотографии процесса, а последовательность решений: от задачи и материалов до проверки,
              упаковки и передачи готового изделия.
            </p>
          </div>
